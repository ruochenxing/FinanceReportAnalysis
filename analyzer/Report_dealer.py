...
# 基于最近4年的年报数据和最近一年的财报数据
from pyqt import contants


class Report_dealer:

    def __init__(self, scode='603993', years=None):
        if years is None:
            years = contants.YEARS
        self.scode = scode
        self.years = years
        self.info = self.getData(self.scode, self.years)
        '''报表'''
        self.balanceS = {}
        self.incomeS = {}
        self.cashFlowS = {}
    ...
    def getData(self, scode, years):
        ...
        datas = mgtable.find({"code": str(scode)}, {"_id": 0}).sort('year', pymongo.DESCENDING)
        results = []
        for data in datas:
            result = {}
            for year in years:
                temp = {}
                if (str(year) + '-12-31') in data:
                    temp.update(data[str(year) + '-12-31'])
                    # 数据打平
                    for item in temp:
    ...
    def getData_n12(self, scode):
        ...
        data = mgtable.find({"code": str(scode)}, {"_id": 0})
        return data
    ...
    def balanceSheet(self):
        ...
        '''整理后放入字典balanceS'''
        balanceS = {}
        balanceS["zwjc"] = info_all[0]["zwjc"]
        balanceS["code"] = info_all[0]["code"]
        balanceS["type"] = "资产负债表"
        ...
        info_all_n12 = self.last12
        '''将最近月份的资产负债表信息添加到balanceS中'''
        balanceS["year"][:0] = [2022]
    ...
    def incomeStm(self):
        info_all = list(self.info)
        incomeS = {}
        incomeS["zwjc"] = info_all[0]["zwjc"]
        incomeS["code"] = info_all[0]["code"]
        incomeS["type"] = "利润表"
        incomeS["year"] = [info["year"] for info in info_all]
        incomeS["报表日期"] = [info["报表日期"] for info in info_all]
        ...
        incomeS["其中:对联营企业和合营企业的投资收益"] = [info["其中:对联营企业和合营企业的投资收益"] for info in
                                                          info_all]
        ...
        info_all_n12 = self.last12
        '''将最近月份的信息添加到incomeS中'''
        n = 4  # n是2018年，上一年在list中的位置
        incomeS["year"][:0] = [2022]
        incomeS["报表日期"][:0] = [info_all_n12["报表日期"][0]]
        incomeS["一、营业总收入"][:0] = [
            info_all_n12["一、营业总收入"][n] - info_all_n12["一、营业总收入"][n + (4 - n)] +
            info_all_n12["一、营业总收入"][0]]
        incomeS["营业收入"][:0] = [
            info_all_n12["营业收入"][n] - info_all_n12["营业收入"][n + (4 - n)] + info_all_n12["营业收入"][0]]
        incomeS["二、营业总成本"][:0] = [
            info_all_n12["二、营业总成本"][n] - info_all_n12["二、营业总成本"][n + (4 - n)] +
            info_all_n12["二、营业总成本"][0]]
        incomeS["营业成本"][:0] = [
            info_all_n12["营业成本"][n] - info_all_n12["营业成本"][n + (4 - n)] + info_all_n12["营业成本"][0]]
        incomeS["营业税金及附加"][:0] = [
            info_all_n12["营业税金及附加"][n] - info_all_n12["营业税金及附加"][n + (4 - n)] +
            info_all_n12["营业税金及附加"][0]]
        incomeS["销售费用"][:0] = [
            info_all_n12["销售费用"][n] - info_all_n12["销售费用"][n + (4 - n)] + info_all_n12["销售费用"][0]]
        incomeS["管理费用"][:0] = [
            info_all_n12["管理费用"][n] - info_all_n12["管理费用"][n + (4 - n)] + info_all_n12["管理费用"][0]]
        incomeS["财务费用"][:0] = [
            info_all_n12["财务费用"][n] - info_all_n12["财务费用"][n + (4 - n)] + info_all_n12["财务费用"][0]]
        incomeS["资产减值损失"][:0] = [
            info_all_n12["资产减值损失"][n] - info_all_n12["资产减值损失"][n + (4 - n)] + info_all_n12["资产减值损失"][
                0]]
        incomeS["公允价值变动收益"][:0] = [
            info_all_n12["公允价值变动收益"][n] - info_all_n12["公允价值变动收益"][n + (4 - n)] +
            info_all_n12["公允价值变动收益"][0]]
        incomeS["投资收益"][:0] = [
            info_all_n12["投资收益"][n] - info_all_n12["投资收益"][n + (4 - n)] + info_all_n12["投资收益"][0]]
        incomeS["其中:对联营企业和合营企业的投资收益"][:0] = [
            info_all_n12["其中:对联营企业和合营企业的投资收益"][n] -
            info_all_n12["其中:对联营企业和合营企业的投资收益"][n + (4 - n)] +
            info_all_n12["其中:对联营企业和合营企业的投资收益"][0]]
        incomeS["汇兑收益"][:0] = [
            info_all_n12["汇兑收益"][n] - info_all_n12["汇兑收益"][n + (4 - n)] + info_all_n12["汇兑收益"][0]]
        incomeS["三、营业利润"][:0] = [
            info_all_n12["三、营业利润"][n] - info_all_n12["三、营业利润"][n + (4 - n)] + info_all_n12["三、营业利润"][0]]
        incomeS["加:营业外收入"][:0] = [
            info_all_n12["加:营业外收入"][n] - info_all_n12["加:营业外收入"][n + (4 - n)] +
            info_all_n12["加:营业外收入"][0]]
        incomeS["减：营业外支出"][:0] = [
            info_all_n12["减：营业外支出"][n] - info_all_n12["减：营业外支出"][n + (4 - n)] +
            info_all_n12["减：营业外支出"][0]]
        incomeS["其中：非流动资产处置损失"][:0] = [
            info_all_n12["其中：非流动资产处置损失"][n] - info_all_n12["其中：非流动资产处置损失"][n + (4 - n)] +
            info_all_n12["其中：非流动资产处置损失"][
                0]]
        incomeS["四、利润总额"][:0] = [
            info_all_n12["四、利润总额"][n] - info_all_n12["四、利润总额"][n + (4 - n)] + info_all_n12["四、利润总额"][0]]
        incomeS["减：所得税费用"][:0] = [
            info_all_n12["减：所得税费用"][n] - info_all_n12["减：所得税费用"][n + (4 - n)] +
            info_all_n12["减：所得税费用"][0]]
        incomeS["五、净利润"][:0] = [
            info_all_n12["五、净利润"][n] - info_all_n12["五、净利润"][n + (4 - n)] + info_all_n12["五、净利润"][0]]
        incomeS["归属于母公司所有者的净利润"][:0] = [
            info_all_n12["归属于母公司所有者的净利润"][n] - info_all_n12["归属于母公司所有者的净利润"][n + (4 - n)] +
            info_all_n12["归属于母公司所有者的净利润"][0]]
        incomeS["少数股东损益"][:0] = [
            info_all_n12["少数股东损益"][n] - info_all_n12["少数股东损益"][n + (4 - n)] + info_all_n12["少数股东损益"][
                0]]
        incomeS["基本每股收益(元/股)"][:0] = [
            info_all_n12["基本每股收益(元/股)"][n] - info_all_n12["基本每股收益(元/股)"][n + (4 - n)] +
            info_all_n12["基本每股收益(元/股)"][0]]
        incomeS["稀释每股收益(元/股)"][:0] = [
            info_all_n12["稀释每股收益(元/股)"][n] - info_all_n12["稀释每股收益(元/股)"][n + (4 - n)] +
            info_all_n12["稀释每股收益(元/股)"][0]]
        incomeS["七、其他综合收益"][:0] = [
            info_all_n12["七、其他综合收益"][n] - info_all_n12["七、其他综合收益"][n + (4 - n)] +
            info_all_n12["七、其他综合收益"][0]]
        incomeS["八、综合收益总额"][:0] = [
            info_all_n12["八、综合收益总额"][n] - info_all_n12["八、综合收益总额"][n + (4 - n)] +
            info_all_n12["八、综合收益总额"][0]]
        incomeS["归属于母公司所有者的综合收益总额"][:0] = [
            info_all_n12["归属于母公司所有者的综合收益总额"][n] - info_all_n12["归属于母公司所有者的综合收益总额"][
                n + (4 - n)] +
            info_all_n12["归属于母公司所有者的综合收益总额"][0]]
        incomeS["归属于少数股东的综合收益总额"][:0] = [
            info_all_n12["归属于少数股东的综合收益总额"][n] - info_all_n12["归属于少数股东的综合收益总额"][
                n + (4 - n)] +
    ...
    def cashFlowStm(self):
        info_all = list(self.info)
        cashFlowS = {}
        print("Report_dealer origin db data info_all")
        ...
        cashFlowS["year"] = [info["year"] for info in info_all]
        cashFlowS["报表日期"] = [info["报表日期"] for info in info_all]
        ...
        cashFlowS["处置固定资产、无形资产和其他长期资产所收回的现金净额"] = [
            info["处置固定资产、无形资产和其他长期资产所收回的现金净额"] for info in info_all]
        cashFlowS["处置子公司及其他营业单位收到的现金净额"] = [info["处置子公司及其他营业单位收到的现金净额"] for info
                                                               in info_all]
        ...
        cashFlowS["购建固定资产、无形资产和其他长期资产所支付的现金"] = [
            info["购建固定资产、无形资产和其他长期资产所支付的现金"] for info in info_all]
        cashFlowS["投资所支付的现金"] = [info["投资所支付的现金"] for info in info_all]
        cashFlowS["取得子公司及其他营业单位支付的现金净额"] = [info["取得子公司及其他营业单位支付的现金净额"] for info
                                                               in info_all]
        ...
        cashFlowS["其中：子公司吸收少数股东投资收到的现金"] = [info["其中：子公司吸收少数股东投资收到的现金"] for info in
                                                              info_all]
        ...
        cashFlowS["分配股利、利润或偿付利息所支付的现金"] = [info["分配股利、利润或偿付利息所支付的现金"] for info in
                                                            info_all]
        cashFlowS["其中：子公司支付给少数股东的股利、利润"] = [info["其中：子公司支付给少数股东的股利、利润"] for info in
                                                             info_all]
        ...
        cashFlowS["四、汇率变动对现金及现金等价物的影响"] = [info["四、汇率变动对现金及现金等价物的影响"] for info in
                                                            info_all]
        ...
        cashFlowS["固定资产折旧、油气资产折耗、生产性物资折旧"] = [info["固定资产折旧、油气资产折耗、生产性物资折旧"] for
                                                                 info in info_all]
        ...
        cashFlowS["处置固定资产、无形资产和其他长期资产的损失"] = [info["处置固定资产、无形资产和其他长期资产的损失"] for
                                                                  info in info_all]
        ...
        '''将最近月份的信息添加到incomeS中'''
        n = 4  # n是2018年，上一年在list中的位置
        cashFlowS["year"][:0] = [2022]
        cashFlowS["报表日期"][:0] = [info_all_n12["报表日期"][0]]
        cashFlowS["销售商品、提供劳务收到的现金"][:0] = [
            info_all_n12["销售商品、提供劳务收到的现金"][n] - info_all_n12["销售商品、提供劳务收到的现金"][n + (4 - n)] +
            info_all_n12["销售商品、提供劳务收到的现金"][0]]
        cashFlowS["收到的税费返还"][:0] = [
            info_all_n12["收到的税费返还"][n] - info_all_n12["收到的税费返还"][n + (4 - n)] +
            info_all_n12["收到的税费返还"][0]]
        cashFlowS["收到的其他与经营活动有关的现金"][:0] = [
            info_all_n12["收到的其他与经营活动有关的现金"][n] - info_all_n12["收到的其他与经营活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["收到的其他与经营活动有关的现金"][0]]
        cashFlowS["经营活动现金流入小计"][:0] = [
            info_all_n12["经营活动现金流入小计"][n] - info_all_n12["经营活动现金流入小计"][n + (4 - n)] +
            info_all_n12["经营活动现金流入小计"][0]]
        cashFlowS["购买商品、接受劳务支付的现金"][:0] = [
            info_all_n12["购买商品、接受劳务支付的现金"][n] - info_all_n12["购买商品、接受劳务支付的现金"][n + (4 - n)] +
            info_all_n12["购买商品、接受劳务支付的现金"][0]]
        cashFlowS["支付给职工以及为职工支付的现金"][:0] = [
            info_all_n12["支付给职工以及为职工支付的现金"][n] - info_all_n12["支付给职工以及为职工支付的现金"][
                n + (4 - n)] +
            info_all_n12["支付给职工以及为职工支付的现金"][0]]
        cashFlowS["支付的各项税费"][:0] = [
            info_all_n12["支付的各项税费"][n] - info_all_n12["支付的各项税费"][n + (4 - n)] +
            info_all_n12["支付的各项税费"][0]]
        cashFlowS["支付的其他与经营活动有关的现金"][:0] = [
            info_all_n12["支付的其他与经营活动有关的现金"][n] - info_all_n12["支付的其他与经营活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["支付的其他与经营活动有关的现金"][0]]
        cashFlowS["经营活动现金流出小计"][:0] = [
            info_all_n12["经营活动现金流出小计"][n] - info_all_n12["经营活动现金流出小计"][n + (4 - n)] +
            info_all_n12["经营活动现金流出小计"][0]]
        cashFlowS["经营活动产生的现金流量净额"][:0] = [
            info_all_n12["经营活动产生的现金流量净额"][n] - info_all_n12["经营活动产生的现金流量净额"][n + (4 - n)] +
            info_all_n12["经营活动产生的现金流量净额"][
                0]]
        cashFlowS["收回投资所收到的现金"][:0] = [
            info_all_n12["收回投资所收到的现金"][n] - info_all_n12["收回投资所收到的现金"][n + (4 - n)] +
            info_all_n12["收回投资所收到的现金"][0]]
        cashFlowS["取得投资收益所收到的现金"][:0] = [
            info_all_n12["取得投资收益所收到的现金"][n] - info_all_n12["取得投资收益所收到的现金"][n + (4 - n)] +
            info_all_n12["取得投资收益所收到的现金"][0]]
        cashFlowS["处置固定资产、无形资产和其他长期资产所收回的现金净额"][:0] = [
            info_all_n12["处置固定资产、无形资产和其他长期资产所收回的现金净额"][n] -
            info_all_n12["处置固定资产、无形资产和其他长期资产所收回的现金净额"][n + (4 - n)] +
            info_all_n12["处置固定资产、无形资产和其他长期资产所收回的现金净额"][0]]
        cashFlowS["处置子公司及其他营业单位收到的现金净额"][:0] = [
            info_all_n12["处置子公司及其他营业单位收到的现金净额"][n] -
            info_all_n12["处置子公司及其他营业单位收到的现金净额"][n + (4 - n)] +
            info_all_n12["处置子公司及其他营业单位收到的现金净额"][0]]
        cashFlowS["收到的其他与投资活动有关的现金"][:0] = [
            info_all_n12["收到的其他与投资活动有关的现金"][n] - info_all_n12["收到的其他与投资活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["收到的其他与投资活动有关的现金"][0]]
        cashFlowS["投资活动现金流入小计"][:0] = [
            info_all_n12["投资活动现金流入小计"][n] - info_all_n12["投资活动现金流入小计"][n + (4 - n)] +
            info_all_n12["投资活动现金流入小计"][0]]
        cashFlowS["购建固定资产、无形资产和其他长期资产所支付的现金"][:0] = [
            info_all_n12["购建固定资产、无形资产和其他长期资产所支付的现金"][n] -
            info_all_n12["购建固定资产、无形资产和其他长期资产所支付的现金"][n + (4 - n)] +
            info_all_n12["购建固定资产、无形资产和其他长期资产所支付的现金"][0]]
        cashFlowS["投资所支付的现金"][:0] = [
            info_all_n12["投资所支付的现金"][n] - info_all_n12["投资所支付的现金"][n + (4 - n)] +
            info_all_n12["投资所支付的现金"][0]]
        cashFlowS["取得子公司及其他营业单位支付的现金净额"][:0] = [
            info_all_n12["取得子公司及其他营业单位支付的现金净额"][n] -
            info_all_n12["取得子公司及其他营业单位支付的现金净额"][n + (4 - n)] +
            info_all_n12["取得子公司及其他营业单位支付的现金净额"][0]]
        cashFlowS["支付的其他与投资活动有关的现金"][:0] = [
            info_all_n12["支付的其他与投资活动有关的现金"][n] - info_all_n12["支付的其他与投资活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["支付的其他与投资活动有关的现金"][0]]
        cashFlowS["投资活动现金流出小计"][:0] = [
            info_all_n12["投资活动现金流出小计"][n] - info_all_n12["投资活动现金流出小计"][n + (4 - n)] +
            info_all_n12["投资活动现金流出小计"][0]]
        cashFlowS["投资活动产生的现金流量净额"][:0] = [
            info_all_n12["投资活动产生的现金流量净额"][n] - info_all_n12["投资活动产生的现金流量净额"][n + (4 - n)] +
            info_all_n12["投资活动产生的现金流量净额"][
                0]]
        cashFlowS["吸收投资收到的现金"][:0] = [
            info_all_n12["吸收投资收到的现金"][n] - info_all_n12["吸收投资收到的现金"][n + (4 - n)] +
            info_all_n12["吸收投资收到的现金"][0]]
        cashFlowS["其中：子公司吸收少数股东投资收到的现金"][:0] = [
            info_all_n12["其中：子公司吸收少数股东投资收到的现金"][n] -
            info_all_n12["其中：子公司吸收少数股东投资收到的现金"][n + (4 - n)] +
            info_all_n12["其中：子公司吸收少数股东投资收到的现金"][0]]
        cashFlowS["取得借款收到的现金"][:0] = [
            info_all_n12["取得借款收到的现金"][n] - info_all_n12["取得借款收到的现金"][n + (4 - n)] +
            info_all_n12["取得借款收到的现金"][0]]
        cashFlowS["发行债券收到的现金"][:0] = [
            info_all_n12["发行债券收到的现金"][n] - info_all_n12["发行债券收到的现金"][n + (4 - n)] +
            info_all_n12["发行债券收到的现金"][0]]
        cashFlowS["收到其他与筹资活动有关的现金"][:0] = [
            info_all_n12["收到其他与筹资活动有关的现金"][n] - info_all_n12["收到其他与筹资活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["收到其他与筹资活动有关的现金"][0]]
        cashFlowS["筹资活动现金流入小计"][:0] = [
            info_all_n12["筹资活动现金流入小计"][n] - info_all_n12["筹资活动现金流入小计"][n + (4 - n)] +
            info_all_n12["筹资活动现金流入小计"][0]]
        cashFlowS["偿还债务支付的现金"][:0] = [
            info_all_n12["偿还债务支付的现金"][n] - info_all_n12["偿还债务支付的现金"][n + (4 - n)] +
            info_all_n12["偿还债务支付的现金"][0]]
        cashFlowS["分配股利、利润或偿付利息所支付的现金"][:0] = [
            info_all_n12["分配股利、利润或偿付利息所支付的现金"][n] -
            info_all_n12["分配股利、利润或偿付利息所支付的现金"][n + (4 - n)] +
            info_all_n12["分配股利、利润或偿付利息所支付的现金"][0]]
        cashFlowS["其中：子公司支付给少数股东的股利、利润"][:0] = [
            info_all_n12["其中：子公司支付给少数股东的股利、利润"][n] -
            info_all_n12["其中：子公司支付给少数股东的股利、利润"][n + (4 - n)] +
            info_all_n12["其中：子公司支付给少数股东的股利、利润"][0]]
        cashFlowS["支付其他与筹资活动有关的现金"][:0] = [
            info_all_n12["支付其他与筹资活动有关的现金"][n] - info_all_n12["支付其他与筹资活动有关的现金"][
                n + (4 - n)] +
            info_all_n12["支付其他与筹资活动有关的现金"][0]]
        cashFlowS["筹资活动现金流出小计"][:0] = [
            info_all_n12["筹资活动现金流出小计"][n] - info_all_n12["筹资活动现金流出小计"][n + (4 - n)] +
            info_all_n12["筹资活动现金流出小计"][0]]
        cashFlowS["筹资活动产生的现金流量净额"][:0] = [
            info_all_n12["筹资活动产生的现金流量净额"][n] - info_all_n12["筹资活动产生的现金流量净额"][n + (4 - n)] +
            info_all_n12["筹资活动产生的现金流量净额"][
                0]]
        cashFlowS["四、汇率变动对现金及现金等价物的影响"][:0] = [
            info_all_n12["四、汇率变动对现金及现金等价物的影响"][n] -
            info_all_n12["四、汇率变动对现金及现金等价物的影响"][n + (4 - n)] +
            info_all_n12["四、汇率变动对现金及现金等价物的影响"][0]]
        cashFlowS["五、现金及现金等价物净增加额"][:0] = [
            info_all_n12["五、现金及现金等价物净增加额"][n] - info_all_n12["五、现金及现金等价物净增加额"][n + (4 - n)] +
            info_all_n12["五、现金及现金等价物净增加额"][0]]
        cashFlowS["加:期初现金及现金等价物余额"][:0] = [
            info_all_n12["加:期初现金及现金等价物余额"][n] - info_all_n12["加:期初现金及现金等价物余额"][n + (4 - n)] +
            info_all_n12["加:期初现金及现金等价物余额"][0]]
        cashFlowS["六、期末现金及现金等价物余额"][:0] = [
            info_all_n12["六、期末现金及现金等价物余额"][n] - info_all_n12["六、期末现金及现金等价物余额"][n + (4 - n)] +
            info_all_n12["六、期末现金及现金等价物余额"][0]]
        #
        '''附注'''
        cashFlowS["净利润"][:0] = [
            info_all_n12["净利润"][n] - info_all_n12["净利润"][n + (4 - n)] + info_all_n12["净利润"][0]]
        cashFlowS["未确认的投资损失"][:0] = [
            info_all_n12["未确认的投资损失"][n] - info_all_n12["未确认的投资损失"][n + (4 - n)] +
            info_all_n12["未确认的投资损失"][0]]
        cashFlowS["资产减值准备"][:0] = [
            info_all_n12["资产减值准备"][n] - info_all_n12["资产减值准备"][n + (4 - n)] + info_all_n12["资产减值准备"][
                0]]
        cashFlowS["固定资产折旧、油气资产折耗、生产性物资折旧"][:0] = [
            info_all_n12["固定资产折旧、油气资产折耗、生产性物资折旧"][n] -
            info_all_n12["固定资产折旧、油气资产折耗、生产性物资折旧"][n + (4 - n)] +
            info_all_n12["固定资产折旧、油气资产折耗、生产性物资折旧"][0]]
        cashFlowS["无形资产摊销"][:0] = [
            info_all_n12["无形资产摊销"][n] - info_all_n12["无形资产摊销"][n + (4 - n)] + info_all_n12["无形资产摊销"][
                0]]
        cashFlowS["长期待摊费用摊销"][:0] = [
            info_all_n12["长期待摊费用摊销"][n] - info_all_n12["长期待摊费用摊销"][n + (4 - n)] +
            info_all_n12["长期待摊费用摊销"][0]]
        cashFlowS["待摊费用的减少"][:0] = [
            info_all_n12["待摊费用的减少"][n] - info_all_n12["待摊费用的减少"][n + (4 - n)] +
            info_all_n12["待摊费用的减少"][0]]
        cashFlowS["预提费用的增加"][:0] = [
            info_all_n12["预提费用的增加"][n] - info_all_n12["预提费用的增加"][n + (4 - n)] +
            info_all_n12["预提费用的增加"][0]]
        cashFlowS["处置固定资产、无形资产和其他长期资产的损失"][:0] = [
            info_all_n12["处置固定资产、无形资产和其他长期资产的损失"][n] -
            info_all_n12["处置固定资产、无形资产和其他长期资产的损失"][n + (4 - n)] +
            info_all_n12["处置固定资产、无形资产和其他长期资产的损失"][0]]
        cashFlowS["固定资产报废损失"][:0] = [
            info_all_n12["固定资产报废损失"][n] - info_all_n12["固定资产报废损失"][n + (4 - n)] +
            info_all_n12["固定资产报废损失"][0]]
        cashFlowS["公允价值变动损失"][:0] = [
            info_all_n12["公允价值变动损失"][n] - info_all_n12["公允价值变动损失"][n + (4 - n)] +
            info_all_n12["公允价值变动损失"][0]]
        cashFlowS["递延收益增加（减：减少）"][:0] = [
            info_all_n12["递延收益增加（减：减少）"][n] - info_all_n12["递延收益增加（减：减少）"][n + (4 - n)] +
            info_all_n12["递延收益增加（减：减少）"][0]]
        cashFlowS["预计负债"][:0] = [
            info_all_n12["预计负债"][n] - info_all_n12["预计负债"][n + (4 - n)] + info_all_n12["预计负债"][0]]
        cashFlowS["投资损失"][:0] = [
            info_all_n12["投资损失"][n] - info_all_n12["投资损失"][n + (4 - n)] + info_all_n12["投资损失"][0]]
        cashFlowS["递延所得税资产减少"][:0] = [
            info_all_n12["递延所得税资产减少"][n] - info_all_n12["递延所得税资产减少"][n + (4 - n)] +
            info_all_n12["递延所得税资产减少"][0]]
        cashFlowS["递延所得税负债增加"][:0] = [
            info_all_n12["递延所得税负债增加"][n] - info_all_n12["递延所得税负债增加"][n + (4 - n)] +
            info_all_n12["递延所得税负债增加"][0]]
        cashFlowS["存货的减少"][:0] = [
            info_all_n12["存货的减少"][n] - info_all_n12["存货的减少"][n + (4 - n)] + info_all_n12["存货的减少"][0]]
        cashFlowS["经营性应收项目的减少"][:0] = [
            info_all_n12["经营性应收项目的减少"][n] - info_all_n12["经营性应收项目的减少"][n + (4 - n)] +
            info_all_n12["经营性应收项目的减少"][0]]
        cashFlowS["经营性应付项目的增加"][:0] = [
            info_all_n12["经营性应付项目的增加"][n] - info_all_n12["经营性应付项目的增加"][n + (4 - n)] +
            info_all_n12["经营性应付项目的增加"][0]]
        cashFlowS["已完工尚未结算款的减少(减:增加)"][:0] = [
            info_all_n12["已完工尚未结算款的减少(减:增加)"][n] - info_all_n12["已完工尚未结算款的减少(减:增加)"][
                n + (4 - n)] +
            info_all_n12["已完工尚未结算款的减少(减:增加)"][0]]
        cashFlowS["已结算尚未完工款的增加(减:减少)"][:0] = [
            info_all_n12["已结算尚未完工款的增加(减:减少)"][n] - info_all_n12["已结算尚未完工款的增加(减:减少)"][
                n + (4 - n)] +
        ...
        cashFlowS["经营活动产生现金流量净额"][:0] = [
            info_all_n12["经营活动产生现金流量净额"][n] - info_all_n12["经营活动产生现金流量净额"][n + (4 - n)] +
            info_all_n12["经营活动产生现金流量净额"][0]]
        cashFlowS["债务转为资本"][:0] = [
            info_all_n12["债务转为资本"][n] - info_all_n12["债务转为资本"][n + (4 - n)] + info_all_n12["债务转为资本"][
                0]]
        cashFlowS["一年内到期的可转换公司债券"][:0] = [
            info_all_n12["一年内到期的可转换公司债券"][n] - info_all_n12["一年内到期的可转换公司债券"][n + (4 - n)] +
            info_all_n12["一年内到期的可转换公司债券"][
                0]]
        cashFlowS["融资租入固定资产"][:0] = [
            info_all_n12["融资租入固定资产"][n] - info_all_n12["融资租入固定资产"][n + (4 - n)] +
            info_all_n12["融资租入固定资产"][0]]
        cashFlowS["现金的期末余额"][:0] = [
            info_all_n12["现金的期末余额"][n] - info_all_n12["现金的期末余额"][n + (4 - n)] +
            info_all_n12["现金的期末余额"][0]]
        cashFlowS["现金的期初余额"][:0] = [
            info_all_n12["现金的期初余额"][n] - info_all_n12["现金的期初余额"][n + (4 - n)] +
            info_all_n12["现金的期初余额"][0]]
        cashFlowS["现金等价物的期末余额"][:0] = [
            info_all_n12["现金等价物的期末余额"][n] - info_all_n12["现金等价物的期末余额"][n + (4 - n)] +
            info_all_n12["现金等价物的期末余额"][0]]
        cashFlowS["现金等价物的期初余额"][:0] = [
            info_all_n12["现金等价物的期初余额"][n] - info_all_n12["现金等价物的期初余额"][n + (4 - n)] +
            info_all_n12["现金等价物的期初余额"][0]]
        cashFlowS["现金及现金等价物的净增加额"][:0] = [
            info_all_n12["现金及现金等价物的净增加额"][n] - info_all_n12["现金及现金等价物的净增加额"][n + (4 - n)] +
            info_all_n12["现金及现金等价物的净增加额"][
                0]]
