    ...
    def comment_maker(self):
        ...
        if value < 100:
            if float(data[2]["资产部分"]["现金与约当现金(%)"][0] * 100) < 100:
                ...
                evaluate4.append(("短期外债偏高,公司目前有{0:d}成是现金资产.".format(
                    math.floor(float(data[2]["资产部分"]["现金与约当现金(%)"][0] * 100) / 10)), "worse"))
            else:
...
<!--</span>-->
  ...
  {data41}
    ...
    <!-- 审计意见 !-->
            ...
            data21=evaluate2[0][0], data22=evaluate2[1][0], data23=evaluate2[2][0], data24=evaluate2[3][0],
            data25=evaluate2[4][0],
            ...
            lev21=evaluate2[0][1], lev22=evaluate2[1][1], lev23=evaluate2[2][1], lev24=evaluate2[3][1],
            lev25=evaluate2[4][1],
