...
class Pushbtn_diy(QtWidgets.QPushButton):
    ...
    def enterEvent(self, QEvent):
        # # #鼠标进入时触发
        self.setStyleSheet(
            "background-color: rgb(31,200,253);border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));border-radius: 4px;")

    def leaveEvent(self, QEvent):
        # #鼠标离开时触发
        self.setStyleSheet(
            "background-color: rgb(7,188,252);border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));border-radius: 4px;")
